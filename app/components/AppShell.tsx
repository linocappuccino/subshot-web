      ...
      <header className="sticky top-0 z-40 backdrop-blur-xl bg-[#161616]/80 border-b border-white/8">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 grid grid-cols-[auto_1fr_auto] items-center gap-4">
          ...
          <div className="flex items-center gap-4 justify-self-end">
            {/* 2026-09-18, Lino: "Feedback und Devlog brauchen wir nicht mehr" —
                Nav-Links entfernt, Routen (/devlog, /feedback) + Backend absichtlich
                unangetastet gelassen (gleiches Muster wie SUBLIs devlog-Nav-Entfernung,
                siehe project_subli_devlog_nav_removal): /devlog hat eine eingebaute
                ?post=<id> Deep-Link-Faehigkeit, die weiter funktionieren muss, falls
                ein Ghost-Post-Link geteilt wird. */}
            <CreditsNavLink />
            {showTeamLink && (
